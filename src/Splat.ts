...
export interface SplatData {
  ...
  /**
   * Method for iterating over the splat centers.
...
export class Splat extends THREE.Mesh<SplatGeometry, THREE.ShaderMaterial> {
   ...
   */
  private uniforms: ReturnType<typeof Splat.makeUniforms>;
  ...
  constructor(splatData: SplatData, options: Record<string, boolean> = {}) {
    ...
    super(new SplatGeometry(splatData.maxSplats), material);
    ...
    material.uniforms.numSplats.value = splatData.numSplats;
