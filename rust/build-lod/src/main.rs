...
fn process_file(filename: String, max_sh_out: Option<u8>, chunked: bool, merge_filter: bool, unlod: bool) {
...
fn main() {
    ...
    for filename in filenames {
        ...
        process_file(filename, max_sh_out, chunked, merge_filter, unlod);
    }
}
