...
// create splats from current parameters
...
async function main() {
  ...
  // add sky
  const skyGeometry = new THREE.SphereGeometry(8, 60, 40);
  const skyMaterial = new THREE.MeshBasicMaterial({
    //map: new THREE.TextureLoader().load(`${ASSETS_BASE}/sky.jpeg`),
  ...
  // advanced noise parameter controls
