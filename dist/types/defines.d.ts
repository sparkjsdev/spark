...
export declare const SPLAT_PAGED_WIDTH_BITS = 12;
export declare const SPLAT_PAGED_HEIGHT_BITS = 12;
export declare const SPLAT_PAGED_WIDTH: number;
export declare const SPLAT_PAGED_HEIGHT: number;
